...
class OrderFormPage extends React.Component<OrderFormProps, OrderFormState> {
  ...
  render() {
    ...
    return (
      <PageBase title="Offre" navigation="MapMarket CRM / Offre ">
        {isFetching ? (
          <div>
          ...
          >
            {({ submitForm, isSubmitting }) => (
              <Form>
                ...
                <p style={styles.productList}>Liste de produits: </p>
                <Divider />
                      ...
                      {order.products.map((product, index) => (
                        <ListItem key={index}>
                          <ListItemText
                            ...
                            secondary={`Loyer:  ${product.unitPrice}`}
                          />
                          <IconButton
                ...
                <div style={styles.buttons}>
                  ...
                  <Button
                    ...
                    color="secondary"
                  >
                    <ContentCreate /> Ajouter de produit
                  </Button>
                </div>

                <React.Fragment>
                  <Dialog
                    title="Ajouter de produit"
